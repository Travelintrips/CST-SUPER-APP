...
export const airFreightOrdersTable = pgTable("air_freight_orders", {
  ...
  serviceMode: text("service_mode").notNull().default("airport_to_airport"),
  ...
  totalVolumetricWeight: numeric("total_volumetric_weight", { precision: 12, scale: 3 }),
  chargeableWeight: numeric("chargeable_weight", { precision: 12, scale: 3 }),
  volumeCbm: numeric("volume_cbm", { precision: 12, scale: 3 }),
  dimensionRows: jsonb("dimension_rows"),
  etdRequested: text("etd_requested"),
  pickupDate: date("pickup_date"),
  readyCargoDate: date("ready_cargo_date"),
  preferredFlightDate: date("preferred_flight_date"),
  targetArrivalDate: date("target_arrival_date"),
