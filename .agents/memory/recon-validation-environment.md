...
**How to apply:** Run dependency restore, shared-library typecheck, API typecheck, and target QRIS/ERP tests first. Treat missing baseline tables as a dev-schema prerequisite rather than as a QRIS/ERP regression.