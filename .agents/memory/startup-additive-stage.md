...
**How to apply:** Give the repair its own stable registry name, wire it into both the server chain and standalone development runner, backfill only from canonical parents, and leave unresolved legacy ownership NULL so payment paths remain fail-closed.