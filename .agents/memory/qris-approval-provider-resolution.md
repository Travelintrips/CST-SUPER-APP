...
QRIS Bank Reconciliation approval is decided by live QRIS payment method, H-1 calendar date, exact canonical-MDR net, company equality, and unreconciled/duplicate state. Provider, group, account, direction, rail labels, candidate status, and stale snapshots are not business blockers.
