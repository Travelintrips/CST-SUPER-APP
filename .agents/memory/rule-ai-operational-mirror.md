...
**How to apply:** Pertahankan `recon_rules` sebagai sumber runtime. Gunakan link mirror khusus untuk Rule AI dan invalidasi cache rule perusahaan setelah create, update, atau deactivate. Rematch hanya kartu manual review historis tanpa alasan/safeguard tercatat; jangan membuka ulang transaksi yang sudah diblokir safeguard jurnal.