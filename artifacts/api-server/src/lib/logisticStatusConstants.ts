...
export const CUSTOMER_WA_MESSAGES: Record<string, (orderNumber: string, trackUrl?: string) => string> = {
  ...
  "Order Received": (n, u) =>
    ...
    `\nTerima kasih telah menggunakan B2B Marketplace and Logistic.`,
  ...
  "Delivered": (n, u) =>
    ...
    `━━━━━━━━━━━━━━━━\n` +
    `No Order : *${n}*\n\n` +
    `Muatan Anda telah berhasil dikirim. Terima kasih telah menggunakan B2B Marketplace and Logistic!` +
    (u ? `\n\n🔗 Detail pengiriman:\n${u}` : ""),
  ...
  "Completed": (n, u) =>
    ...
    `━━━━━━━━━━━━━━━━\n` +
    `No Order : *${n}*\n\n` +
    `Order Anda telah selesai sepenuhnya. Terima kasih telah menggunakan layanan B2B Marketplace and Logistic!` +
    (u ? `\n\n🔗 Detail order:\n${u}` : ""),
