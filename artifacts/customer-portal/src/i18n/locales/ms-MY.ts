...
const locale: DeepRecord = {
  nav: {
    ...
    myRfqs: 'RFQ Saya',
    myPurchaseOrders: 'Pesanan Pembelian Saya',
  ...
  oceanFreightBooking: {
    ...
    optionEconomyDesc: 'Harga paling berpatutan',
    optionStandard: 'Standard',
    optionStandardDesc: 'Keseimbangan harga & masa',
    optionPriority: 'Keutamaan',
    optionPriorityDesc: 'Transit terpantas',
    errorFillPorts: 'Sila isi pelabuhan asal dan destinasi',
    errorSelectContainer: 'Sila pilih jenis kontena',
    errorFillCbm: 'Sila isi CBM atau berat kasar',
    errorNameRequired: 'Nama diperlukan',
    errorContactRequired: 'Telefon atau e-mel diperlukan',
    successTitle: 'Pertanyaan Dihantar!',
    successDesc: 'Pasukan kami akan mengesahkan sebut harga akhir dan menghubungi anda tidak lama lagi.',
    orderNumberLabel: 'Nombor Pesanan',
    orderAgain: 'Pesanan Baharu',
    backToEstimate: 'Kembali ke Anggaran',
    senderTitle: 'Butiran Penghantar',
    contactInfo: 'Maklumat Hubungan',
    fullName: 'Nama Penuh *',
    phoneWa: 'Telefon / WhatsApp *',
    email: 'E-mel',
    company: 'Syarikat',
    targetEtd: 'Sasaran ETD',
    commodity: 'Komoditi',
    confirmNote: 'Pasukan kami akan menghubungi anda untuk mengesahkan harga akhir dalam masa 1×24 jam.',
    sending: 'Menghantar...',
    submitInquiry: 'Hantar Pertanyaan',
    changeSearch: 'Tukar Carian',
    resultsTitle: 'Anggaran Pengangkutan Laut',
    noRatesTitle: 'Kadar Tidak Tersedia',
    noRatesDesc: 'Kami belum mempunyai kadar untuk laluan ini. Pasukan kami akan mencari tawaran terbaik.',
    requestManualQuote: 'Minta Sebut Harga Manual',
    daysTransit: 'hari transit',
    estimate: 'Anggaran',
    fixedPrice: 'Harga Tetap',
    hideBreakdown: 'Sembunyikan',
    showBreakdown: 'Lihat',
    breakdownTitle: 'Pecahan Kos',
    docCharges: 'Caj Dokumen',
    totalEstimate: 'Jumlah Anggaran',
    requestManual: 'Minta Manual',
    requestFinal: 'Minta Sebut Harga Akhir',
    priceNote: 'Anggaran awal — harga akhir disahkan selepas menerima kadar dari syarikat perkapalan.',
    back: 'Kembali',
    subtitle: 'Pengangkutan laut FCL & LCL',
    shippingRoute: 'Laluan Penghantaran',
    selectPort: 'Pilih pelabuhan...',
    cargoType: 'Jenis Kargo',
    containerQty: 'Kuantiti Kontena',
    grossWeightKg: 'Berat Kasar (kg)',
    colliCount: 'Jumlah Kotak',
    cargoCondition: 'Keadaan Kargo',
    additionalServices: 'Perkhidmatan Tambahan',
    additionalServicesHint: 'Pilih perkhidmatan yang diperlukan (pilihan)',
    calculating: 'Mengira Anggaran...',
    checkPrice: 'Semak Anggaran Harga',
    fclFull: 'FCL — Kontena Penuh',
    lclLess: 'LCL — Kontena Separa',
  
    tracking: 'Penjejakan',
    titleOceanFreight: 'Kargo Laut',
    labelOriginPort: 'Pelabuhan Asal *',
    labelDestPort: 'Pelabuhan Destinasi *',
    labelTradeType: 'Jenis Perdagangan',
    labelServiceMode: 'Mod Perkhidmatan',
    labelContainerType: 'Jenis Kontena *',
    labelVolumeCbm: 'Isipadu (CBM)',
    transshipmentDirect: 'Terus',
    transshipmentViaTS: 'Via T/S',
    tradeTypeExport: 'Eksport',
    tradeTypeImport: 'Import',
    tradeTypeDomestic: 'Domestik',
    tradeTypeCrossBorder: 'Rentas Sempadan',
    ...
    cargoGeneral: 'Kargo Am',
    cargoDG: 'Kargo DG',
    cargoReefer: 'Reefer',
    cargoFragile: 'Mudah Pecah',
    cargoOversize: 'Saiz Besar',
    cargoHighValue: 'Nilai Tinggi',
    addonTruckingPickup: 'Kutipan Trak',
    addonTruckingDelivery: 'Penghantaran Trak',
    addonCustoms: 'Pelepasan Kastam',
    addonInsurance: 'Insurans',
  ...
  customerOrder: {
    ...
    estimatedArrival: 'Anggaran',
    productService: 'Produk / Perkhidmatan',
    truck: 'Trak',
    internal: 'Dalaman',
    external: 'Luaran',
    total: 'Jumlah',
    journeyHistory: 'Sejarah Perjalanan',
    noHistory: 'Tiada sejarah perjalanan.',
    viewDocument: 'Lihat Dokumen',
    progressConfirm: 'Pengesahan',
    progressPickup: 'Pengambilan',
    progressJourney: 'Dalam Perjalanan',
    progressDelivered: 'Dihantar',
    progressCompleted: 'Selesai',
  },
  ppjkTrack: {
    loading: 'Memuat penjejakan PPJK…',
    notFound: 'Pesanan Tidak Dijumpai',
    notFoundMsg: 'Nombor pesanan tidak sah atau belum tersedia',
    backToHome: 'Kembali ke Laman Utama',
    statusDraft: 'Draf / Menunggu Pengesahan',
    statusConfirmed: 'Disahkan',
    statusProcessing: 'Sedang Diproses',
    statusSubmitted: 'Dokumen Dihantar ke Kastam',
    statusExamining: 'Dalam Pemeriksaan Kastam',
    statusApproved: 'Diluluskan / SPPB Dikeluarkan',
    statusCompleted: 'Selesai',
    statusCancelled: 'Dibatalkan',
    statusOnHold: 'Ditangguhkan',
    customsPending: 'Menunggu',
    customsAjuFiled: 'Pengisytiharan Kastam Difailkan',
    customsJalurHijau: 'Laluan Hijau',
    customsJalurMerah: 'Laluan Merah',
    customsJalurKuning: 'Laluan Kuning',
    customsSppbIssued: 'SPPB Dikeluarkan',
    customsPaid: 'Duti & Cukai Dibayar',
    customsReleased: 'Barang Dilepaskan',
    actionCreated: 'Pesanan dibuat',
    actionStatusChanged: 'Status dikemaskini',
    actionCustomsStatusChanged: 'Status kastam dikemaskini',
    actionDocumentUploaded: 'Dokumen dimuat naik',
    actionNoteAdded: 'Nota ditambah',
    actionUpdated: 'Data dikemaskini',
    cargoInfo: 'Maklumat Kargo',
    commodity: 'Komoditi',
    route: 'Laluan',
    portOfEntry: 'Pelabuhan Masuk/Keluar',
    kantorPabean: 'Pejabat Kastam',
    grossWeight: 'Berat Kasar',
    koli: 'Pek',
    submissionDate: 'Tarikh Penyerahan',
    customsDocuments: 'Nombor Dokumen Kastam',
    nomorAju: 'No. Pengisytiharan',
    tanggalAju: 'Tarikh Pengisytiharan',
    nomorPib: 'No. PIB',
    nomorPeb: 'No. PEB',
    nomorSppb: 'No. SPPB',
    customsStatusLabel: 'Status Kastam',
    timelineTitle: 'Sejarah Kemaskini',
    lastUpdated: 'Terakhir dikemaskini',
    autoRefresh: 'Halaman dikemaskini secara automatik setiap 30 saat',
    progressLabel: 'Kemajuan Kastam',
    cancelledMsg: 'Pesanan dibatalkan — sila hubungi pasukan kami.',
    onHoldMsg: 'Pesanan ditangguhkan — pasukan kami akan menghubungi anda tidak lama lagi.',
    completedMsg: 'Proses kastam selesai — barangan sedia untuk diambil atau dihantar.',
    showMore: 'Lihat {count} kemaskini lagi',
