...
const locale: DeepRecord = {
  ...
  login: {
    ...
    registerNow: '今すぐ登録',
    phoneFormat: '形式: 081234… または 628… または 8…',
  ...
  marketplaceDetail: {
    ...
    fieldSpecColor: '色',
    fieldSpecSpecies: '種類',
    fieldSpecStorage: '保存方法',
    fieldSpecFreezing: '冷凍方法',
    fieldSpecProcessing: '加工工程',
    fieldSpecShelfLife: '賞味期限',
    fieldSpecNetWeightCarton: '正味重量/カートン',
    fieldSpecNetWeight: '正味重量',
    fieldSpecGrossWeight: '総重量',
    fieldSpecThickness: '厚さ',
    fieldSpecLength: '長さ',
    fieldSpecWidth: '幅',
    fieldSpecHeight: '高さ',
    vendorPublicItems: '公開商品',
    vendorMemberSince: '会員自',
    vendorVerifiedNote: '認証済みベンダー。正式な見積もりは上のボタンからお問い合わせください。',
    vendorProducts: '製品',
    vendorServices: 'サービス',
    relatedTitle: 'このベンダーの他の商品',
  ...
  pabean: {
    ...
    uploadOptional: '関連書類をアップロード（任意）',
    consultDetail: '相談内容 *',
    consultConfirm: '相談料金は当社のPPJKチームによって確認されます。提出後すぐにご連絡いたします。',
    perijinanConsultDetail: '許可の種類 / 相談テーマ *',
    picName: '担当者名',
  ...
  portalDokumen: {
    title: "書類",
    subtitle: "商業請求書と取引書類",
    searchPlaceholder: "書類番号または注文番号を検索...",
    viewAllOrders: "すべての注文を表示",
    transactionDocs: "取引書類",
    documentsCount: "{n}件の書類",
    orderRef: "注文: {number}",
    dueDateLabel: "支払期限",
    noMatchDocs: "一致する書類がありません",
    clearSearch: "検索をクリア",
    emptyTitle: "まだ書類がありません",
    emptyDesc: "注文が確認された後、取引書類がここに表示されます。",
    viewMyOrders: "注文を確認する",
    logisticDocsTitle: "物流チームからの書類",
    logisticDocsDesc: "上記の書類は、出荷の進捗に応じてWhatsAppまたはメールで運営チームから直接送付されます。",
    detailBtn: "詳細",
  },
  portalInvoice: {
    title: "請求書と支払い",
    ...
    emptyDesc: "注文が確認され請求の準備ができた後、請求書がここに表示されます。",
    viewShipments: "出荷を確認する",
    orderRef: "注文: {number}",
    dueDateLabel: "支払期限",
    paymentLink: "支払いリンク",
  },
  ...
  oceanFreightBooking: {
    optionEconomy: 'エコノミー',
    optionEconomyDesc: '最安値',
    optionStandard: 'スタンダード',
    optionStandardDesc: '価格と時間のバランス',
    optionPriority: 'プライオリティ',
    optionPriorityDesc: '最速トランジット',
    errorFillPorts: '出発港と到着港を入力してください',
    errorSelectContainer: 'コンテナタイプを選択してください',
    errorFillCbm: 'CBMまたは総重量を入力してください',
    errorNameRequired: '名前は必須です',
    errorContactRequired: '電話またはメールは必須です',
    successTitle: 'お問い合わせ送信完了！',
    successDesc: '担当者が最終見積を確認後、まもなくご連絡いたします。',
    orderNumberLabel: '注文番号',
    orderAgain: '新規注文',
    backToEstimate: '見積に戻る',
    senderTitle: '送荷主情報',
    contactInfo: '連絡先情報',
    fullName: '氏名 *',
    phoneWa: '電話 / WhatsApp *',
    ...
    targetEtd: '希望ETD',
    commodity: '貨物品名',
    confirmNote: '担当者が1×24時間以内に最終価格確認のためご連絡いたします。',
    sending: '送信中...',
    submitInquiry: 'お問い合わせを送信',
    changeSearch: '検索を変更',
    resultsTitle: '海上運賃見積',
    noRatesTitle: '運賃が見つかりません',
    noRatesDesc: 'このルートの運賃がまだありません。担当者が最適な条件を探します。',
    requestManualQuote: '手動見積を依頼',
    daysTransit: '日間トランジット',
    estimate: '見積',
    fixedPrice: '確定価格',
    hideBreakdown: '非表示',
    showBreakdown: '表示',
    ...
    totalEstimate: '合計見積',
    requestManual: '手動依頼',
    requestFinal: '最終見積を依頼',
    priceNote: '初期見積 — 船社から運賃を受領後に最終価格を確認。',
    back: '戻る',
    subtitle: '海上運送 FCL & LCL',
    shippingRoute: '輸送ルート',
    selectPort: '港を選択...',
    cargoType: '貨物タイプ',
    containerQty: 'コンテナ数量',
    ...
    additionalServicesHint: '必要なサービスを選択（任意）',
    calculating: '見積計算中...',
    checkPrice: '運賃見積を確認',
    fclFull: 'FCL — フルコンテナ',
    lclLess: 'LCL — 混載',
    ...
    tracking: '追跡',
    titleOceanFreight: '海上貨物',
    labelOriginPort: '出発港 *',
    labelDestPort: '仕向け港 *',
    labelTradeType: '取引タイプ',
    labelServiceMode: 'サービスモード',
    labelContainerType: 'コンテナタイプ *',
    labelVolumeCbm: '容量 (CBM)',
    transshipmentDirect: '直行',
    transshipmentViaTS: 'T/S経由',
    tradeTypeExport: '輸出',
    tradeTypeImport: '輸入',
    tradeTypeDomestic: '国内',
    tradeTypeCrossBorder: '越境',
    serviceModePortPort: '港→港',
    serviceModeDoorPort: 'ドア→港',
    serviceModePortDoor: '港→ドア',
    serviceModeDoorDoor: 'ドア→ドア',
    cargoGeneral: '一般貨物',
    cargoDG: '危険物',
    cargoReefer: '冷凍冷蔵',
    cargoFragile: '壊れ物',
    cargoOversize: '過大貨物',
    cargoHighValue: '高価物',
    addonTruckingPickup: 'トラック集荷',
    addonTruckingDelivery: 'トラック配送',
    addonCustoms: '通関',
    addonInsurance: '保険',
    addonFumigation: 'くん蒸',
    addonCOO: '原産地証明',
  ...
  customerOrder: {
    ...
    total: '合計',
    journeyHistory: '輸送履歴',
    noHistory: '輸送履歴がありません。',
    viewDocument: '書類を見る',
    progressConfirm: '確認',
    progressPickup: 'ピックアップ',
    progressJourney: '輸送中',
    progressDelivered: '配達済み',
    progressCompleted: '完了',
  },
  ppjkTrack: {
    loading: 'PPJK追跡を読み込み中…',
    notFound: '注文が見つかりません',
    notFoundMsg: '無効な注文番号またはまだ利用できません',
    backToHome: 'ホームに戻る',
    statusDraft: '下書き / 確認待ち',
    statusConfirmed: '確認済み',
    statusProcessing: '処理中',
    statusSubmitted: '税関に書類提出済み',
    statusExamining: '税関審査中',
    statusApproved: '承認済み / SPPB発行',
    statusCompleted: '完了',
    statusCancelled: 'キャンセル',
    statusOnHold: '保留中',
    customsPending: '保留中',
    customsAjuFiled: '税関申告書提出済み',
    customsJalurHijau: 'グリーンチャンネル',
    customsJalurMerah: 'レッドチャンネル',
    customsJalurKuning: 'イエローチャンネル',
    customsSppbIssued: 'SPPB発行',
    customsPaid: '関税・税金納付済み',
    customsReleased: '貨物放出',
    actionCreated: '注文作成',
    actionStatusChanged: 'ステータス更新',
    actionCustomsStatusChanged: '税関ステータス更新',
    actionDocumentUploaded: '書類アップロード',
    actionNoteAdded: 'メモ追加',
    actionUpdated: 'データ更新',
    cargoInfo: '貨物情報',
    commodity: '商品',
    route: 'ルート',
    ...
    koli: '荷物数',
    submissionDate: '提出日',
    customsDocuments: '税関書類番号',
    nomorAju: '申告番号',
    tanggalAju: '申告日',
    nomorPib: 'PIB番号',
    nomorPeb: 'PEB番号',
    nomorSppb: 'SPPB番号',
    customsStatusLabel: '税関状態',
    timelineTitle: '更新履歴',
    lastUpdated: '最終更新',
    autoRefresh: 'ページは30秒ごとに自動更新',
    progressLabel: '税関進捗',
    cancelledMsg: '注文はキャンセルされました — チームにご連絡ください。',
    onHoldMsg: '注文は保留中です — チームがすぐにご連絡します。',
    completedMsg: '税関手続きが完了しました — 貨物は引き取りまたは配送の準備ができています。',
    showMore: '{count}件の更新を表示',
    showLess: '折りたたむ',
    tradeExport: '輸出',
    tradeImport: '輸入',
  },
