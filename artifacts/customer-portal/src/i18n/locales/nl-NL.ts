...
const locale: DeepRecord = {
  nav: {
    ...
    myRfqs: 'Mijn RFQ\'s',
    myPurchaseOrders: 'Mijn Inkooporders',
  ...
  orders: {
    ...
    type: 'Type',
    total: 'Totaal',
    emptyStateMsg: 'Uw bestellingen verschijnen hier.',
  ...
  oceanFreightBooking: {
    ...
    optionEconomyDesc: 'Voordeligste prijs',
    optionStandard: 'Standaard',
    optionStandardDesc: 'Balans prijs & tijd',
    optionPriority: 'Prioriteit',
    optionPriorityDesc: 'Snelste transit',
    errorFillPorts: 'Vul haven van vertrek en bestemming in',
    errorSelectContainer: 'Selecteer containertype',
    errorFillCbm: 'Vul CBM of brutogwicht in',
    errorNameRequired: 'Naam is verplicht',
    errorContactRequired: 'Telefoon of e-mail is verplicht',
    successTitle: 'Aanvraag verzonden!',
    successDesc: 'Ons team bevestigt de definitieve offerte en neemt snel contact met u op.',
    orderNumberLabel: 'Bestelnummer',
    orderAgain: 'Nieuwe bestelling',
    backToEstimate: 'Terug naar schatting',
    senderTitle: 'Afzendergegevens',
    contactInfo: 'Contactinformatie',
    fullName: 'Volledige naam *',
    phoneWa: 'Telefoon / WhatsApp *',
    email: 'E-mail',
    company: 'Bedrijf',
    targetEtd: 'Gewenste ETD',
    commodity: 'Goederen',
    confirmNote: 'Ons team neemt binnen 1×24 uur contact op ter bevestiging van de definitieve prijs.',
    sending: 'Verzenden...',
    submitInquiry: 'Aanvraag verzenden',
    changeSearch: 'Zoekopdracht wijzigen',
    resultsTitle: 'Zeevrachtraming',
    noRatesTitle: 'Geen tarieven beschikbaar',
    noRatesDesc: 'We hebben nog geen tarieven voor deze route. Ons team vindt het beste aanbod.',
    requestManualQuote: 'Handmatige offerte aanvragen',
    daysTransit: 'dagen transit',
    estimate: 'Schatting',
    fixedPrice: 'Vaste prijs',
    hideBreakdown: 'Verbergen',
    showBreakdown: 'Weergeven',
    breakdownTitle: 'Kostenoverzicht',
    docCharges: 'Documentkosten',
    totalEstimate: 'Totaalschatting',
    requestManual: 'Handmatig aanvragen',
    requestFinal: 'Definitieve offerte aanvragen',
    priceNote: 'Eerste schatting — definitieve prijs bevestigd na ontvangst tarief van de rederij.',
    back: 'Terug',
    subtitle: 'Zeevrachtvervoer FCL & LCL',
    shippingRoute: 'Verzendroute',
    selectPort: 'Selecteer haven...',
    cargoType: 'Ladingtype',
    containerQty: 'Aantal containers',
    grossWeightKg: 'Brutogewicht (kg)',
    colliCount: 'Aantal colli',
    cargoCondition: 'Ladingstoestand',
    additionalServices: 'Extra diensten',
    additionalServicesHint: 'Selecteer benodigde diensten (optioneel)',
    calculating: 'Schatting berekenen...',
    checkPrice: 'Prijsschatting controleren',
    fclFull: 'FCL — Volledige container',
    lclLess: 'LCL — Deellading',
  
    tracking: 'Tracking',
    titleOceanFreight: 'Zeevracht',
    labelOriginPort: 'Herkomstshaven *',
    labelDestPort: 'Bestemmingshaven *',
    labelTradeType: 'Handelstype',
    labelServiceMode: 'Servicemodus',
    ...
    tradeTypeDomestic: 'Binnenland',
    tradeTypeCrossBorder: 'Grensoverschrijdend',
    serviceModePortPort: 'Haven tot Haven',
    serviceModeDoorPort: 'Deur tot Haven',
    serviceModePortDoor: 'Haven tot Deur',
    serviceModeDoorDoor: 'Deur tot Deur',
    cargoGeneral: 'Algemene Vracht',
    cargoDG: 'Gevaarlijke Goederen',
    cargoReefer: 'Koel',
    cargoFragile: 'Breekbaar',
    cargoOversize: 'Oversized',
    cargoHighValue: 'Hoge Waarde',
    addonTruckingPickup: 'Vrachtwagen Ophalen',
    addonTruckingDelivery: 'Vrachtwagen Levering',
    addonCustoms: 'Douaneafhandeling',
    addonInsurance: 'Verzekering',
    addonFumigation: 'Fumigatie',
    addonCOO: 'COO / Certificaat',
    addonWarehouse: 'Magazijnbehandeling',

    breakdownTHCOrigin: 'THC Herkomst',
    breakdownTHCDestination: 'THC Bestemming',
    breakdownTrucking: 'Wegvervoer',
    breakdownCustomsClearance: 'Douaneafhandeling',
},
  orderStatusLabels: {
  ...
  customerOrder: {
    loading: 'Bestelstatus laden...',
    notFound: 'Bestelling niet gevonden',
    priceSummary: 'Prijsoverzicht',
    origin: 'Herkomst',
    destination: 'Bestemming',
    orderDate: 'Besteldatum',
    estimatedArrival: 'Geschat',
    productService: 'Product / Dienst',
    truck: 'Vrachtwagen',
    internal: 'Intern',
    external: 'Extern',
    total: 'Totaal',
    journeyHistory: 'Reisgeschiedenis',
    noHistory: 'Geen reisgeschiedenis.',
    viewDocument: 'Document bekijken',
    progressConfirm: 'Bevestigen',
    progressPickup: 'Ophalen',
    progressJourney: 'Onderweg',
    progressDelivered: 'Afgeleverd',
    progressCompleted: 'Voltooid',
  },
  ppjkTrack: {
    loading: 'PPJK-tracking laden…',
    notFound: 'Bestelling niet gevonden',
    notFoundMsg: 'Ongeldig bestelnummer of nog niet beschikbaar',
    backToHome: 'Terug naar home',
    statusDraft: 'Concept / In afwachting van bevestiging',
    statusConfirmed: 'Bevestigd',
    statusProcessing: 'In behandeling',
    statusSubmitted: 'Documenten ingediend bij douane',
    statusExamining: 'Douaneonderzoek gaande',
    statusApproved: 'Goedgekeurd / SPPB uitgegeven',
    statusCompleted: 'Voltooid',
    statusCancelled: 'Geannuleerd',
    statusOnHold: 'In de wacht',
    customsPending: 'In afwachting',
    customsAjuFiled: 'Douaneaangifte ingediend',
    customsJalurHijau: 'Groene kanaal',
    customsJalurMerah: 'Rode kanaal',
    customsJalurKuning: 'Gele kanaal',
    customsSppbIssued: 'SPPB uitgegeven',
    customsPaid: 'Rechten & belastingen betaald',
    customsReleased: 'Goederen vrijgegeven',
    actionCreated: 'Bestelling aangemaakt',
    actionStatusChanged: 'Status bijgewerkt',
    actionCustomsStatusChanged: 'Douanestatus bijgewerkt',
    actionDocumentUploaded: 'Document geüpload',
    actionNoteAdded: 'Notitie toegevoegd',
    actionUpdated: 'Gegevens bijgewerkt',
    cargoInfo: 'Vracht informatie',
    commodity: 'Goederen',
    route: 'Route',
    portOfEntry: 'In-/uitvoerhaven',
    kantorPabean: 'Douanekantoor',
    grossWeight: 'Brutgewicht',
    koli: 'Pakketten',
    submissionDate: 'Indieningsdatum',
    customsDocuments: 'Douanedocumentnummers',
    nomorAju: 'Aangiftenummer',
    tanggalAju: 'Aangiftedatum',
    nomorPib: 'PIB-nummer',
    nomorPeb: 'PEB-nummer',
    nomorSppb: 'SPPB-nummer',
    customsStatusLabel: 'Douanestatus',
    timelineTitle: 'Updategeschiedenis',
    lastUpdated: 'Laatst bijgewerkt',
    autoRefresh: 'Pagina vernieuwt automatisch elke 30 seconden',
    progressLabel: 'Douanevoortgang',
    cancelledMsg: 'Bestelling geannuleerd — neem contact op met ons team.',
    onHoldMsg: 'Bestelling in de wacht — ons team neemt binnenkort contact op.',
    completedMsg: 'Douaneproces voltooid — goederen klaar voor ophalen of levering.',
    showMore: '{count} meer updates bekijken',
