...
const locale: DeepRecord = {
  ...
  calculator: {
    ...
    back: '返回',
    pageTitleFull: '物流費用計算器',
    pageSubtitle: '即時物流費用估算，不同服務類型採用不同計算公式。',
    badgeTransparent: '透明',
    badgeFormula: '精確公式',
    badgeLiveRates: '即時費率',
    fallbackWarning: '顯示的費率使用預設估算，因為最新費率資料無法載入。這些數字不一定反映實際費率，請聯絡我們的團隊確認報價。',
    formTitle: '計算表單',
    formSubtitleSelected: '已根據此服務調整欄位',
    formSubtitleEmpty: '選擇服務以開始計算',
    stepSelectService: '選擇服務類型',
    serviceSelectedHint: '已選擇 {service} — 顯示此服務的相關欄位',
    emptyHint: '請在上方選擇服務類型以繼續',
    stepGeneralInfo: '基本資訊',
    customerName: '客戶 / 公司名稱',
    customerNamePlaceholder: 'PT. Maju Bersama',
    selectIncotermsPlaceholder: '選擇貿易條件',
    originCity: '出發城市',
    destinationCity: '目的城市',
    pol: '裝貨港 (POL)',
    pod: '卸貨港 (POD)',
    autoFilled: '自動填入',
    cargoDescLabel: '貨物描述 / 品名',
    cargoDescPlaceholder: '工業機械、電子產品等',
    addInsurance: '加購保險',
    addInsuranceSub: '+{pct}% 貨物價值',
    detailSeaFreight: '海運詳細資訊',
    detailAirFreight: '空運詳細資訊',
    detailCustoms: 'PPJK / 清關詳細資訊',
    detailTrucking: '卡車 / 國內運輸詳細資訊',
    detailWarehousing: '倉儲詳細資訊',
    detailProjectCargo: '專案貨物詳細資訊',
    shipmentType: '運輸類型',
    perCbm: '每 CBM',
    fullContainer: '整櫃',
    containerType: '貨櫃類型',
    grossWeightKg: '毛重 (kg)',
    grossWeightPlaceholder: '毛重 (kg)',
    commodity: '品名',
    commodityPlaceholder: '貨物品名',
    readyDate: '備貨日期',
    dangerousGoods: '危險品',
    dgSurcharge: '加收危險品附加費',
    inlandTrucking: '內陸運輸',
    originAirport: '起運機場',
    destAirport: '目的機場',
    piecesCount: '件數',
    ...
    dimensionsPerPiece: '每件尺寸 (cm)',
    volWeightNote: '體積重量 = (長 × 寬 × 高) / 6000 | 計費重量 = max(毛重, 體積重量)',
    temperatureControlled: '溫控',
    tradeType: '貿易類型',
    document: '單據',
    hsCode: 'HS Code',
    customsValue: '完稅價格 (CIF, IDR)',
    customsValueNote: '用於計算進口稅和增值稅估算',
    npwp: '進口商稅號 (NPWP)',
    applicationNumber: '申報號碼（選填）',
    ...
    quantity: '數量',
    duration: '期間（天）',
    durationPlaceholder: '30 天',
    inboundHandling: '入庫處理',
    outboundHandling: '出庫處理',
    inventoryManagement: '庫存管理',
    projectCargoWarning: '專案貨物為客製化服務。本計算提供預算範圍估算，非固定報價。',
    cargoDimensions: '貨物尺寸（公尺）',
    weightPerPiece: '每件重量（噸）',
    specialRequirements: '特殊需求（可複選）',
    ...
    routeSurveySub: '特殊路線勘查',
    escortRequired: 'Escort Required',
    escortSub: '特殊護送服務',
    additionalNotes: '備註',
    notesPlaceholder: '特殊指示、額外需求、截止日期等',
    calculateButton: '計算費用估算',
    resultEmpty: '填寫左側表單，然後按下計算費用估算按鈕',
    projectCargoResultTitle: '專案貨物',
    estimatedBudgetRange: '預算範圍估算',
    cargoVolume: '貨物體積',
    toRange: '至',
    estimateIndicative: '此估算僅供參考，正式報價需要勘查和特殊計算。',
    discussWa: '透過 WhatsApp 討論',
    requestQuoteFull: '申請正式報價',
    cargoMetrics: '貨物計量',
    costBreakdown: '費用明細',
    subtotal: '小計',
    insuranceLabel: '保險',
    estimateGrandTotal: '估算合計',
    grandTotalNote: '*估算，不含意外費用',
    savePdf: '儲存 PDF',
    exportCsv: '匯出 CSV',
    exportJson: '匯出 JSON',
    quoteSentTitle: '申請已傳送！',
    quoteSentDesc: 'B2B Marketplace and Logistic 團隊將在 1×24 工作小時內與您聯繫。',
    quoteModalTitle: '申請正式報價',
    quoteModalSubtitle: '我們的團隊將為您準備正式報價',
    fullName: '姓名',
    ...
    sending: '傳送中...',
    sendRequest: '傳送申請',
    validationNoService: '請先選擇服務類型。',
    validationNoDest: '目的地為必填。',
    validationNoWeight: '貨物重量（毛重）為必填。',
    validationNoCbm: 'LCL 需要填寫 CBM 體積。',
    validationNoDist: '距離（KM）為必填。',
    validationNoWhQty: '數量和儲存期間為必填。',
    errorSendFail: '傳送失敗，請重試。',
    validationName: '姓名為必填',
    validationWa: 'WhatsApp 號碼為必填',
    errorServerConnect: '無法連接到伺服器，請檢查網路連線。',
    services: {
      seaFreight: '海運',
      airFreight: '空運',
      customs: '報關代理',
  ...
  airFreight: {
    ...
    sectionRoute: '航線',
    originCity: '起運城市',
    originAirport: '起運機場代碼',
    destCity: '目的地城市',
    destAirport: '目的地機場代碼',
    cargoTypeLabel: '貨物類型',
    sectionCargo: '貨物詳情',
    commodityLabel: '品名',
    commodityPlaceholder: '例：電子產品、紡織品、食品...',
    dimensionLabel: '尺寸與重量（每件）',
    addKoli: '新增件數',
    calcEstimate: '計算估價',
    sectionRate: '運價選項',
    noRateMsg: '此航線暫無可用運價，我們的團隊將為您提供最優報價。',
    routeDirect: '直飛',
    routeTransit: '中轉',
    dayUnit: '天',
    estimateTotal: '預估總價',
    rateSelected: '已選運價',
    sectionSchedule: '時間安排',
    pickupDate: '提貨日期',
    flightDate: '期望航班日期',
    arrivalDate: '目標到達日期',
    sectionAddons: '附加服務',
    addonsSelected: '已選 {count} 項服務',
    sectionContact: '聯絡方式',
    fullName: '姓名',
    companyName: '公司名稱',
    whatsapp: 'WhatsApp',
    ...
    summaryRoute: '航線',
    summaryService: '服務',
    summaryIncoterm: '貿易術語',
    summaryChargeable: '計費重量',
    summaryRate: '航空公司',
    summaryEstimate: '預估價格',
    summaryAddons: '附加服務',
    serviceUnit: '項',
    selectRateHint: '請在上方選擇運價以查看最終價格估算。',
    requestQuote: '提交詢價',
    requestHint: '我們的團隊將在24小時內與您聯繫，確認訂單並提供最終報價。',
    successTitle: '請求已發送！',
    successDesc: '我們的團隊將儘快與您聯繫，確認發貨詳情。',
    orderNoLabel: '訂單號',
    trackOrder: '追蹤訂單',
    validationAirport: '起運和目的地機場代碼為必填項',
    validationWeight: '請先填寫貨物重量',
    validationNoRate: '暫無可用運價，但您仍可提交詢價',
    validationEstimateFail: '獲取運價估算失敗',
    validationName: '姓名為必填項',
    validationPhone: 'WhatsApp號碼為必填項',
    validationCommodity: '品名為必填項',
    validationWeightFill: '請在提交前填寫貨物重量',
    validationSuccess: '空運詢價請求提交成功！',
    validationSubmitFail: '空運詢價請求提交失敗',
  },
  ...
  jasaDetail: {
    ...
    airAddQty: '新增其他數量',
    airCalcSummary: '計算摘要（{count} 種數量類型）：',
    truckStep1Label: '貨運詳情',
    truckStep2Label: '車隊與確認',
    scheduleLabel: '取貨時間表',
    orderNowLabel: '立即下單',
    orderNowDesc: '今天安排取貨',
    activeLabel: '啟用',
    ...
    stopReceiverPhoneLabel: '第 {n} 站收件人電話',
    destPlaceholder: '目的地城市...',
    receiverNameLabel: '收件人姓名',
    receiverPhoneLabel: '收件人電話',
    receiverNamePlaceholder: '收件人姓名',
    optimizeRouteDesc: '對站點排序以提高旅程效率。',
    distanceEstLabel: '預計距離',
    calculatingLabel: '計算中...',
    autoLabel: '✓ 自動',
    cargoLabel: '貨物資訊',
    cargoCategoryLabel: '貨物類別',
    koliQtyLabel: '包裹數量',
    dimensionsLabel: '尺寸與體積',
    totalVolumeLabel: '總體積 / 立方',
    addDimension: '新增尺寸',
    notesPlaceholder: '關於貨物、處理或特殊說明的附加備註...',
    uploadPhotoLabel: '上傳貨物照片',
    photoCount: '{n}/5 張照片',
    photoPickerHint: '選擇照片 (jpg, jpeg, png, webp) · 最多 5 張',
    paymentLabel: '付款方式',
    transferDesc: '透過銀行轉帳付款',
    gatewayDesc: '透過線上閘道付款',
    selectTransferLabel: '選擇轉帳類型',
    fullPayDesc: '全額付款',
    terminDesc: '定期分期',
    dpDesc: '頭期款',
    terminPeriodLabel: '分期週期',
    nextPaymentLabel: '下次結算',
    afterDelivery: '交貨後',
    net30Days: '淨 30 天',
    net60Days: '淨 60 天',
    installments: '分期付款',
    orderSummaryLabel: '訂單摘要',
    summarySchedule: '時間表',
    summaryNow: '現在',
    summaryRoute: '路線',
    summaryDistance: '距離',
    ...
    summaryCargo: '貨物',
    summaryPhoto: '照片',
    photoUploaded: '已上傳 {n} 張照片',
    summaryPayment: '付款',
    payTransferFull: '轉帳 · 全額付款',
    payTransferTermin: '轉帳 · 分期 {term}',
    payTransferDp: '轉帳 · 頭期款',
    payTransfer: '轉帳',
    recommended: '推薦',
    notSuitable: '不適合',
    distanceKmLabel: '距離 (km)',
    costBreakdownLabel: '費用明細',
    totalEstLabel: '總估算',
    fillRateHint: '填寫費率/km 和距離以查看費用估算。',
    addedToCartMsg: '{name} 已成功新增到訂單！',
    estimatedSubtotal: '預計小計',
    estimatedSubtotalNote: '預計價格 · 由 CST 團隊確認',
    addToOrderBtn: '新增到訂單',
    addedToCartConfirm: '{name} 已成功新增到訂單',
    recalcBtn: '重新計算',
    proceedBtn: '繼續預訂',
    sidebarInfoLabel: '服務資訊',
    sidebarTruckingNote: '基於距離和車隊計算',
    availableLabel: '● 可用',
    vehicleLabel: '車輛',
    distanceLabel: '距離',
    viewCartBtn: '查看訂單購物車',
    whyUsLabel: '為什麼選擇 B2B Marketplace and Logistic？',
    trustBadge1: '持牌及官方註冊',
    trustBadge2: '快速回應 & 專業',
    trustBadge3: '貨物安全 & 受保護',
    trustBadge4: 'WhatsApp 支援 24/7',
    relatedServicesLabel: '其他 {category} 服務',
    viewAllServices: '查看所有服務',
    backBtn: '← 返回',
    nextBtn: '下一步',
    pendingOrderTitle: '此服務已選為配送',
    pendingOrderLabel: '訂單：',
    pendingOrderAdded: '服務已新增。點擊確認繼續。',
    pendingOrderHint: '請先點擊「新增到訂單」。',
    confirmOrderBtn: '確認並繼續訂單',
    cancelBtn: '取消',
    toastAddServiceFirst: '請先將服務新增到訂單',
    toastAddServiceDesc: '繼續前請點擊「新增到訂單」按鈕。',
    toastAutoDistance: '自動距離：{km} km',
    toastDistanceFail: '距離計算失敗',
    toastDistanceFailDesc: '手動輸入距離',
    toastNoDate: '選擇取貨日期',
    toastDatePast: '取貨日期不能早於今天',
    toastNoTime: '選擇取貨時間',
    toastNoSenderName: '輸入寄件人姓名',
    toastNoSenderPhone: '輸入寄件人電話',
    toastNoOrigin: '輸入起始城市',
    toastNoDest: '輸入目的地城市',
    toastNoReceiverName: '輸入收件人姓名',
    toastNoReceiverPhone: '輸入收件人電話',
    toastNoStopReceiverName: '輸入第 {n} 站收件人姓名',
    toastNoStopReceiverPhone: '輸入第 {n} 站收件人電話',
    toastNoCargo: '選擇貨物類別（必填）',
    toastNoKoli: '包裹數量必須填寫（> 0）',
    toastNoWeight: '毛重必須填寫（> 0）',
    toastNoPhoto: '至少上傳 1 張貨物照片（必填）',
    toastNoPayment: '選擇付款方式（必填）',
    toastNoTransferType: '選擇轉帳類型（全額付款、分期或頭期款）',
    toastFillCalc: '請先填寫計算器資料',
    toastNoVehicle: '請先選擇車隊',
    toastAddedToCart: '{name} 已新增到訂單購物車！',
    toastRouteOptimized: '路線已優化',
    toastRouteOptimizedDesc: '站點順序已自動重新排列。',
    ...
    destPort: '目的地港',
    containerType: '貨櫃類型',
    selectContainer: '選擇貨櫃',
    freightRate: '運費 (IDR)',
    handlingFeeIDR: '操作費 (IDR)',
    weightKg: '重量 (kg)',
    ratePerCbm: '費率/CBM',
    minimumCharge: '最低收費',
    customsFeeIDR: '報關費',
  ...
  portalDokumen: {
    title: "文件",
    subtitle: "您的商業發票和交易文件",
    searchPlaceholder: "搜尋文件或訂單號...",
    viewAllOrders: "查看所有訂單",
    transactionDocs: "交易文件",
    documentsCount: "{n} 個文件",
    orderRef: "訂單: {number}",
    dueDateLabel: "到期日",
    noMatchDocs: "沒有匹配的文件",
    clearSearch: "清除搜尋",
    emptyTitle: "尚無文件",
    emptyDesc: "交易文件將在您的訂單確認後顯示在此處。",
    viewMyOrders: "查看我的訂單",
    logisticDocsTitle: "物流團隊文件",
    logisticDocsDesc: "以上文件由運營團隊透過WhatsApp或電子郵件直接發送，與貨運進度同步。",
    detailBtn: "詳情",
  },
  portalInvoice: {
    title: "發票與付款",
    subtitle: "您的帳單歷史記錄和付款狀態",
    totalUnpaid: "未付總額",
    invoiceList: "發票列表",
    payBtn: "付款",
    emptyTitle: "尚無發票",
    emptyDesc: "發票將在您的訂單確認並準備開票後顯示在此處。",
    viewShipments: "查看我的貨運",
    orderRef: "訂單: {number}",
    dueDateLabel: "到期日",
    paymentLink: "付款連結",
  },
  ...
  oceanFreightBooking: {
    optionEconomy: '經濟型',
    optionEconomyDesc: '最優惠價格',
    optionStandard: '標準型',
    optionStandardDesc: '價格與時效的平衡',
    optionPriority: '優先型',
    optionPriorityDesc: '最快運輸',
    errorFillPorts: '請填寫起運港和目的港',
    errorSelectContainer: '請選擇貨櫃類型',
    errorFillCbm: '請填寫CBM或毛重',
    errorNameRequired: '姓名為必填項',
    errorContactRequired: '電話或電子郵件為必填項',
    successTitle: '詢價已發送！',
    successDesc: '我們的團隊將確認最終報價並盡快與您聯繫。',
    ...
    targetEtd: '目標出發日期',
    commodity: '貨物品名',
    confirmNote: '我們的團隊將在1×24小時內聯繫您確認最終價格。',
    sending: '發送中...',
    submitInquiry: '發送詢價',
    changeSearch: '修改搜尋',
    resultsTitle: '海運運費估算',
    noRatesTitle: '暫無運價',
    noRatesDesc: '該航線暫無運價，我們的團隊將為您尋找最優報價。',
    requestManualQuote: '請求人工報價',
    daysTransit: '天運輸',
    estimate: '估算',
    fixedPrice: '固定價格',
    hideBreakdown: '隱藏',
    ...
    requestManual: '人工請求',
    requestFinal: '請求最終報價',
    priceNote: '初始估算 — 從船公司收到運價後確認最終價格。',
    back: '返回',
    subtitle: '海運 FCL & LCL',
    shippingRoute: '運輸路線',
    selectPort: '選擇港口...',
    ...
    colliCount: '件數',
    cargoCondition: '貨物狀態',
    additionalServices: '增值服務',
    additionalServicesHint: '選擇所需服務（可選）',
    calculating: '正在計算估價...',
    checkPrice: '查詢運費估算',
    fclFull: 'FCL — 整箱',
    lclLess: 'LCL — 拼箱',
    ...
    tracking: '追蹤',
    titleOceanFreight: '海運',
    labelOriginPort: '出發港 *',
    labelDestPort: '目的港 *',
    labelTradeType: '貿易類型',
    labelServiceMode: '服務模式',
    labelContainerType: '貨櫃類型 *',
    labelVolumeCbm: '體積 (CBM)',
    transshipmentDirect: '直航',
    transshipmentViaTS: 'T/S轉運',
    tradeTypeExport: '出口',
    tradeTypeImport: '進口',
    tradeTypeDomestic: '國內',
    tradeTypeCrossBorder: '跨境',
    serviceModePortPort: '港到港',
    serviceModeDoorPort: '門到港',
    serviceModePortDoor: '港到門',
    serviceModeDoorDoor: '門到門',
    cargoGeneral: '一般貨物',
    cargoDG: '危險品',
    cargoReefer: '冷藏',
    cargoFragile: '易碎品',
    cargoOversize: '超大件',
    cargoHighValue: '貴重品',
    addonTruckingPickup: '卡車取貨',
    addonTruckingDelivery: '卡車送貨',
    addonCustoms: '報關',
    addonInsurance: '保險',
    addonFumigation: '燻蒸',
    addonCOO: '原產地證書',
    ...
    breakdownTHCOrigin: 'THC 出發港',
    breakdownTHCDestination: 'THC 目的港',
    breakdownTrucking: '卡車運輸',
    breakdownCustomsClearance: '清關',
},
  orderStatusLabels: {
    "New Order": "新訂單",
  ...
  ppjkTrack: {
    loading: '正在載入PPJK追蹤…',
    notFound: '未找到訂單',
    notFoundMsg: '無效的訂單號或尚未可用',
    backToHome: '返回首頁',
    statusDraft: '草稿 / 待確認',
    statusConfirmed: '已確認',
    statusProcessing: '處理中',
    statusSubmitted: '文件已提交海關',
    statusExamining: '海關檢驗中',
    statusApproved: '已批准 / SPPB已發放',
    statusCompleted: '已完成',
    statusCancelled: '已取消',
    statusOnHold: '已暫停',
    customsPending: '待處理',
    customsAjuFiled: '海關申報已提交',
    customsJalurHijau: '綠色通道',
    customsJalurMerah: '紅色通道',
    customsJalurKuning: '黃色通道',
    customsSppbIssued: 'SPPB已發放',
    customsPaid: '關稅已繳納',
    customsReleased: '貨物已放行',
    actionCreated: '訂單已建立',
    actionStatusChanged: '狀態已更新',
    actionCustomsStatusChanged: '海關狀態已更新',
    actionDocumentUploaded: '文件已上傳',
    actionNoteAdded: '備註已新增',
    actionUpdated: '資料已更新',
    cargoInfo: '貨物資訊',
    commodity: '商品',
    route: '路線',
    ...
    koli: '包裹數',
    submissionDate: '提交日期',
    customsDocuments: '海關單據編號',
    nomorAju: '申報編號',
    tanggalAju: '申報日期',
    nomorPib: 'PIB編號',
    nomorPeb: 'PEB編號',
    nomorSppb: 'SPPB編號',
    customsStatusLabel: '海關狀態',
    timelineTitle: '更新歷史',
    lastUpdated: '最後更新',
    autoRefresh: '頁面每30秒自動刷新',
    progressLabel: '海關進度',
    cancelledMsg: '訂單已取消 — 請聯繫我們的團隊。',
    onHoldMsg: '訂單已暫停 — 我們的團隊將盡快聯繫您。',
    completedMsg: '海關流程完成 — 貨物可提取或配送。',
    showMore: '查看{count}條更新',
    showLess: '收起',
    tradeExport: '出口',
    tradeImport: '進口',
  },
