...
const locale: DeepRecord = {
  ...
  pabean: {
    ...
    hoverUploadHint: 'مرر فوق الرمز → رفع الشعار',
  },
  customClearance: {
    ...
    phSpecialNotesPib: 'على سبيل المثال: يحتاج إلى ترخيص استيراد خاص، معدل ضريبي تفضيلي، سلع حساسة، إلخ',
    phGoods2: 'على سبيل المثال: قطع غيار، منسوجات، مواد كيميائية...',
    phPibPebDocNum: 'رقم مستند PIB/PEB',
    ...
    phSpecialNotesUn: 'على سبيل المثال: لم تحصل الشركة بعد على ترخيص API، تسجيل NIB جارٍ...',
  },
  importCalculator: {
  ...
  mktCard: {
    ...
    customClearance: {
      ...
      infoBannerDesc: 'نحن نتولى عملية التخليص الجمركي بالكامل: إعداد مستندات PIB/PEB، التعامل الفعلي في الميناء، وخدمات تحت الاسم للشركات التي لا تملك تراخيص استيراد/تصدير.',
      step1Title: 'اختر نوع الخدمة',
      step1Subtitle: 'اختر خدمة واحدة أو أكثر تحتاجها',
      step2Title: 'تفاصيل الخدمة المختارة',
      step3Title: 'معلومات الطالب / PIC',
      ...
      pibPebDocNum: 'رقم PIB / PEB (إذا كان متوفرًا)',
      ...
      profileAutoFilled: 'تم استرجاع البيانات من ملف تعريف حسابك.',
      ...
      serviceDocFee: 'رسوم خدمة مستند PIB/PEB',
      ...
      handlingServiceDesc: 'تتضمن هذه الخدمة: التنسيق مع السلطات الجمركية، دفع ضريبة الاستيراد والضرائب، تنسيق التفتيش الفعلي (الممر الأحمر)، وإطلاق البضائع إلى مستودعك.',
      pibPebProcessNote: 'سيقوم فريق PPJK لدينا بمعالجة إعداد مستند PIB/PEB بعد استلام جميع البيانات والمستندات. سيتم تأكيد رسوم الخدمة خلال يوم عمل واحد.',
      underNameServiceNote: 'تشمل رسوم خدمة تحت الاسم: استخدام API/NIK، معالجة المستندات، والتعامل مع الجمارك. سيتم تأكيدها من قبل فريقنا بناءً على نوع البضائع وقيمة المعاملة.',
      underNameInfoDesc: 'نحن نقدم تسهيلات الاستيراد/التصدير باستخدام API / NIK الرسمي لشركتنا. مثالي للشركات التي لا تملك ترخيص استيراد/تصدير خاص بها.',
      picName: 'اسم PIC',
      ...
      svc1Desc: 'المعالجة الكاملة وإعداد مستندات إعلان الاستيراد الجمركي (PIB) أو إعلان التصدير الجمركي (PEB)',
      svc1Badge: '1–2 يوم عمل',
      svc2Title: 'معالجة التخليص الجمركي',
      svc2Desc: 'التعامل الفعلي مع عملية التخليص الجمركي في الميناء: تنسيق التفتيش، دفع ضريبة الاستيراد والضرائب، وصولاً إلى إطلاق البضائع من منطقة الجمارك',
      svc2Badge: '1–3 يوم عمل',
      svc3Title: 'خدمات الاستيراد / التصدير تحت الاسم',
    ...
    importCalculator: {
      ...
      noPreferential: 'لا توجد أسعار تفضيلية لهذا FTA',
      resultTitle: 'نتائج الحساب',
      resultNdpbm: 'NDPBM (CIF IDR)',
      ...
      lartasTitle: 'LARTAS — السلع المقيدة/الممنوعة',
      ...
      exportCSV: 'تصدير CSV',
      exportJSON: 'تصدير JSON',
      loadingRates: 'جلب أحدث الأسعار…',
      rateJisdor: 'JISDOR BI — مباشر',
      rateLive: 'السعر المباشر',
      rateEstimate: 'السعر المقدر',
      ...
      incotermCifNote: 'القيمة تشمل الشحن والتأمين بالفعل',
    ...
    pabean: {
      headerTitle: 'إدارة التخليص الجمركي / PPJK',
      headerSubtitle: 'خدمات الجمارك',
      ...
      serviceLabel: 'الخدمة',
      estimatedCost: 'التكلفة المقدرة',
      confirmedAfterDoc: 'سيتم التأكيد بعد مراجعة الوثائق',
      costNote: 'تقديرات التكلفة هي إرشادية. سيتم تأكيد التكاليف النهائية من قبل فريق PPJK لدينا بعد التحقق من الوثائق. سيتواصل فريقنا معك خلال يوم عمل واحد.',
      submitting: 'جارٍ التقديم...',
      submitBtn: 'تقديم طلب PPJK',
      successMsg: 'تم تقديم طلب PPJK بنجاح! سيتواصل فريقنا معك في أقرب وقت ممكن.',
      errorMsg: 'فشل في تقديم الطلب',
      profileAutoFilled: 'تم استرجاع البيانات من ملف حسابك. يمكن تغيير رقم الهاتف فقط.',
      loginToUpload: 'يرجى تسجيل الدخول لتحميل الوثائق',
      uploadOptional: 'تحميل الوثائق ذات الصلة (اختياري)',
      consultDetail: 'موضوع الاستشارة *',
      consultConfirm: 'سيتم تأكيد رسوم الاستشارة من قبل فريق PPJK لدينا. سيتواصلون معك قريبًا بعد التقديم.',
      perijinanConsultDetail: 'نوع التصريح / موضوع الاستشارة *',
      ...
      svc1Desc: 'استشارة متعمقة حول القوانين والمتطلبات الجمركية للأنشطة الاستيرادية',
      svc2Title: 'استشارة قوانين التصدير',
      svc2Desc: 'استشارة متعمقة حول القوانين والمتطلبات الجمركية للأنشطة التصديرية',
      svc3Title: 'استشارة تراخيص الاستيراد والتصدير',
      svc3Desc: 'استشارة حول عمليات الترخيص، NIB، API، والمستندات القانونية للأنشطة الاستيرادية/التصديرية',
      ...
      connectionFailed: 'فشل الاتصال أثناء التحميل',
      missingService: 'نوع الخدمة',
      uploadingProgress: 'جارٍ التحميل...',
      fileFormatError: 'تنسيق غير مدعوم (.{ext}). استخدم PDF، JPG، PNG، DOC، أو DOCX.',
      fileSizeError: 'الملف كبير جدًا ({size} ميغابايت). الحد الأقصى 10 ميغابايت.',
    },
  },
  vendor: {
    register: {
