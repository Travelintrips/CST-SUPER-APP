...
const locale: DeepRecord = {
  ...
  servicesMenu: {
    ...
    consultant: {
      ...
      sub3: 'Import tax calculation (Customs Duty, VAT & Income Tax)',
    },
  ...
  calculator: {
    ...
    projectNote: 'For Project Cargo, please contact our team for a customised quote tailored to your project requirements.',
    services: {
  ...
  pabean: {
    ...
    costNote: 'Cost estimates are indicative. Final costs will be confirmed by our PPJK team after document verification. Our team will contact you within 1 working day.',
    ...
    perijinanConsultDetail: 'Type of licence / consultation topic *',
    picName: 'PIC Name',
  ...
  customClearance: {
    ...
    confirmedWithinHours: 'Confirmed within 1 working day',
    costNote: 'Service fees are indicative and will be confirmed by our PPJK team after document and goods type verification. Our team will contact you within 1 working day.',
    submitting: 'Submitting Request...',
    submitBtn: 'Submit Customs Clearance Request',
    ...
    underNameInfoDesc: 'We provide import/export facilities using our company\'s official API / NIK. Ideal for companies without their own importer/exporter licence.',
    picName: 'PIC Name',
    companyNameLabel: 'Company Name',
    additionalNotes: 'Additional Notes',
    additionalNotesPlaceholder: 'Additional information for our team (optional)',
