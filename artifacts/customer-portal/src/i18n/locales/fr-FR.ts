...
const locale: DeepRecord = {
  nav: {
    ...
    myRfqs: 'Mes RFQs',
    myPurchaseOrders: 'Mes Commandes',
  ...
  orderTask: {
    ...
    cargoCatGeneral: 'Général',
    cargoCatFragile: 'Fragile',
    cargoCatDG: 'Marchandises dangereuses (DG)',
    cargoCatSpecial: 'Manutention spéciale requise',
  ...
  airFreight: {
    ...
    navTitle: 'Fret aérien',
    navBrand: 'CST Logistics',
    heroTitle: 'Réservation de fret aérien',
    heroHint: 'Renseignez les détails de la marchandise et la route de vol',
    sectionRoute: 'Route de vol',
    originCity: "Ville d'origine",
    originAirport: "Code aéroport d'origine",
    destCity: 'Ville de destination',
    destAirport: 'Code aéroport de destination',
    cargoTypeLabel: 'Type de marchandise',
    sectionCargo: 'Détails de la marchandise',
    commodityLabel: 'Marchandise',
    commodityPlaceholder: 'ex. Électronique, Textile, Alimentation...',
    dimensionLabel: 'Dimensions & poids (par colis)',
    addKoli: 'Ajouter un colis',
    calcEstimate: "Calculer l'estimation",
    sectionRate: 'Options tarifaires',
    noRateMsg: "Aucun tarif disponible pour cette route. Notre équipe vous contactera avec la meilleure offre.",
    routeDirect: 'Direct',
    routeTransit: 'Transit',
    dayUnit: 'jours',
    estimateTotal: 'Total estimé',
    rateSelected: 'Tarif sélectionné',
    sectionSchedule: 'Planning',
    pickupDate: "Date d'enlèvement",
    flightDate: 'Date de vol préférée',
    arrivalDate: "Date d'arrivée cible",
    sectionAddons: 'Services supplémentaires',
    addonsSelected: '{count} service(s) sélectionné(s)',
    sectionContact: 'Coordonnées',
    fullName: 'Nom complet',
    companyName: "Nom de l'entreprise",
    whatsapp: 'WhatsApp',
    notes: 'Notes',
    notesPh: 'Informations supplémentaires pour notre équipe...',
    summaryTitle: 'Récapitulatif de réservation',
    summaryRoute: 'Route',
    summaryService: 'Service',
    summaryIncoterm: 'Incoterm',
    summaryChargeable: 'Poids taxable',
    summaryRate: 'Compagnie aérienne',
    summaryEstimate: 'Prix estimé',
    summaryAddons: 'Services supplémentaires',
    serviceUnit: 'service(s)',
    selectRateHint: "Sélectionnez un tarif ci-dessus pour voir l'estimation du prix final.",
    requestQuote: 'Envoyer la demande',
    requestHint: 'Notre équipe vous contactera dans les 24 heures pour confirmation et tarification finale.',
    successTitle: 'Demande envoyée !',
    successDesc: "Notre équipe vous contactera bientôt pour confirmer les détails de l'expédition.",
    orderNoLabel: 'Numéro de commande',
    trackOrder: 'Suivre la commande',
    validationAirport: "Les codes des aéroports d'origine et de destination sont obligatoires",
    validationWeight: "Veuillez d'abord saisir le poids de la marchandise",
    validationNoRate: 'Aucun tarif disponible, mais vous pouvez quand même envoyer une demande',
    validationEstimateFail: "Impossible d'obtenir l'estimation du tarif",
    validationName: 'Le nom complet est obligatoire',
    validationPhone: 'Le numéro WhatsApp est obligatoire',
    validationCommodity: 'La marchandise est obligatoire',
    validationWeightFill: "Veuillez saisir le poids de la marchandise avant d'envoyer",
    validationSuccess: 'Demande de fret aérien envoyée avec succès !',
    validationSubmitFail: "Échec de l'envoi de la demande de fret aérien",
  },
  ...
  jasaDetail: {
    calcTitle: "Calculateur d'estimation des coûts",
    calcSubtitle: 'Remplissez les paramètres du service pour obtenir une estimation de prix',
    airAddQty: 'Ajouter une autre quantité',
    airCalcSummary: 'Résumé du calcul ({count} types de quantité) :',
    truckStep1Label: "Détails de l'expédition",
    truckStep2Label: 'Flotte & Confirmation',
    scheduleLabel: 'Horaire de collecte',
    orderNowLabel: 'Commander maintenant',
    orderNowDesc: "Collecte prévue aujourd'hui",
    activeLabel: 'Actif',
    dateLabel: 'Date',
    timeLabel: 'Heure',
    scheduleDisplay: 'Horaire : {date} à {time}',
    senderLabel: 'Informations expéditeur',
    senderNameLabel: "Nom de l'expéditeur",
    senderNamePlaceholder: "Nom complet de l'expéditeur",
    senderPhoneLabel: "Téléphone de l'expéditeur",
    routeLabel: 'Itinéraire de livraison',
    originPlaceholder: "Ville d'origine...",
    stopCityPlaceholder: 'Ville arrêt {n}...',
    removeStop: "Supprimer l'arrêt",
    stopReceiverNameLabel: "Nom du destinataire à l'arrêt {n}",
    stopReceiverPhoneLabel: "Téléphone du destinataire à l'arrêt {n}",
    destPlaceholder: 'Ville de destination...',
    receiverNameLabel: 'Nom du destinataire',
    receiverPhoneLabel: 'Téléphone du destinataire',
    receiverNamePlaceholder: 'Nom du destinataire',
    optimizeRouteDesc: 'Trier les arrêts pour rendre le trajet plus efficace.',
    distanceEstLabel: 'Distance estimée',
    calculatingLabel: 'Calcul...',
    autoLabel: '✓ Automatique',
    cargoLabel: 'Informations sur la cargaison',
    cargoCategoryLabel: 'Catégorie de cargaison',
    koliQtyLabel: 'Nombre de colis',
    dimensionsLabel: 'Dimensions & Volume',
    totalVolumeLabel: 'Volume total / Cubique',
    addDimension: 'Ajouter une dimension',
    notesPlaceholder: 'Notes supplémentaires sur les marchandises, la manutention ou les instructions spéciales...',
    uploadPhotoLabel: 'Télécharger des photos de cargaison',
    photoCount: '{n}/5 photos',
    photoPickerHint: 'Sélectionner des photos (jpg, jpeg, png, webp) · max. 5 photos',
    paymentLabel: 'Type de paiement',
    transferDesc: 'Payer par virement bancaire',
    gatewayDesc: 'Payer via passerelle en ligne',
    selectTransferLabel: 'Sélectionner le type de virement',
    fullPayDesc: 'Paiement intégral',
    terminDesc: 'Versements périodiques',
    dpDesc: 'Acompte',
    terminPeriodLabel: 'Période de versements',
    nextPaymentLabel: 'Prochain règlement',
    afterDelivery: 'Après livraison',
    net30Days: 'Net 30 jours',
    net60Days: 'Net 60 jours',
    installments: 'Versements échelonnés',
    orderSummaryLabel: 'Récapitulatif de commande',
    summarySchedule: 'Horaire',
    summaryNow: 'Maintenant',
    summaryRoute: 'Itinéraire',
    summaryDistance: 'Distance',
    summaryCategory: 'Catégorie',
    summaryCargo: 'Cargaison',
    summaryPhoto: 'Photos',
    photoUploaded: '{n} photos téléchargées',
    summaryPayment: 'Paiement',
    payTransferFull: 'Virement · Paiement intégral',
    payTransferTermin: 'Virement · Versement {term}',
    payTransferDp: 'Virement · Acompte',
    payTransfer: 'Virement',
    recommended: 'Recommandé',
    notSuitable: 'Non adapté',
    distanceKmLabel: 'Distance (km)',
    costBreakdownLabel: 'Détail des coûts',
    totalEstLabel: 'Total estimé',
    fillRateHint: "Remplissez le tarif/km et la distance pour voir l'estimation.",
    addedToCartMsg: '{name} ajouté à la commande avec succès !',
    estimatedSubtotal: 'Sous-total estimé',
    estimatedSubtotalNote: "Prix estimé · confirmé par l'équipe CST",
    addToOrderBtn: 'Ajouter à la commande',
    addedToCartConfirm: '{name} ajouté à la commande avec succès',
    recalcBtn: 'Recalculer',
    proceedBtn: 'Procéder à la réservation',
    sidebarInfoLabel: 'Informations sur le service',
    sidebarTruckingNote: 'Basé sur le calcul distance & flotte',
    availableLabel: '● Disponible',
    vehicleLabel: 'Véhicule',
    distanceLabel: 'Distance',
    viewCartBtn: 'Voir le panier de commandes',
    whyUsLabel: 'Pourquoi B2B Marketplace and Logistic ?',
    trustBadge1: 'Agréé & officiellement enregistré',
    trustBadge2: 'Réponse rapide & professionnel',
    trustBadge3: 'Cargaison sûre & protégée',
    trustBadge4: 'Support WhatsApp 24/7',
    relatedServicesLabel: 'Autres services {category}',
    viewAllServices: 'Voir tous les services',
    backBtn: '← Retour',
    nextBtn: 'Suivant',
    pendingOrderTitle: 'Ce service est sélectionné comme livraison',
    pendingOrderLabel: 'Commande :',
    pendingOrderAdded: 'Service déjà ajouté. Cliquez sur Confirmer pour continuer.',
    pendingOrderHint: 'Cliquez d\'abord sur "Ajouter à la commande".',
    confirmOrderBtn: 'Confirmer & Continuer la commande',
    cancelBtn: 'Annuler',
    toastAddServiceFirst: "Ajoutez d'abord le service à la commande",
    toastAddServiceDesc: 'Cliquez sur le bouton "Ajouter à la commande" avant de continuer.',
    toastAutoDistance: 'Distance automatique : {km} km',
    toastDistanceFail: 'Échec du calcul de la distance',
    toastDistanceFailDesc: 'Saisir la distance manuellement',
    toastNoDate: 'Sélectionner la date de collecte',
    toastDatePast: "La date de collecte ne peut pas être antérieure à aujourd'hui",
    toastNoTime: "Sélectionner l'heure de collecte",
    toastNoSenderName: "Saisir le nom de l'expéditeur",
    toastNoSenderPhone: "Saisir le téléphone de l'expéditeur",
    toastNoOrigin: "Saisir la ville d'origine",
    toastNoDest: 'Saisir la ville de destination',
    toastNoReceiverName: 'Saisir le nom du destinataire',
    toastNoReceiverPhone: 'Saisir le téléphone du destinataire',
    toastNoStopReceiverName: "Saisir le nom du destinataire à l'arrêt {n}",
    toastNoStopReceiverPhone: "Saisir le téléphone du destinataire à l'arrêt {n}",
    toastNoCargo: 'Sélectionner la catégorie de cargaison (obligatoire)',
    toastNoKoli: 'Le nombre de colis doit être supérieur à 0',
    toastNoWeight: 'Le poids brut doit être supérieur à 0',
    toastNoPhoto: 'Télécharger au moins 1 photo de cargaison (obligatoire)',
    toastNoPayment: 'Sélectionner le type de paiement (obligatoire)',
    toastNoTransferType: 'Sélectionner le type de virement (Paiement intégral, Versements ou Acompte)',
    toastFillCalc: "Remplissez d'abord les données du calculateur",
    toastNoVehicle: "Sélectionner d'abord la flotte de véhicules",
    toastAddedToCart: '{name} ajouté au panier de commandes !',
    toastRouteOptimized: 'Itinéraire optimisé',
    toastRouteOptimizedDesc: 'Ordre des arrêts réorganisé automatiquement.',
  
    destAirport: 'Aéroport de Destination',
    grossWeightKg: 'Poids Brut (kg)',
    quantityPcs: 'Quantité (pièces)',
    lengthCm: 'Longueur (cm)',
    widthCm: 'Largeur (cm)',
    heightCm: 'Hauteur (cm)',
    volWeight: 'Poids Vol.',
    chargeable: 'Facturable',
    ratePerKg: 'Tarif/kg (IDR)',
    ...
    selectContainer: 'Choisir conteneur',
    freightRate: 'Tarif de Fret (IDR)',
    handlingFeeIDR: 'Frais de Manutention (IDR)',
    weightKg: 'Poids (kg)',
    ratePerCbm: 'Tarif/CBM (IDR)',
    minimumCharge: 'Charge Minimale (IDR)',
    customsFeeIDR: 'Frais de Douane (IDR)',
    documentFeeIDR: 'Frais de Documents (IDR)',
    pibPebFee: 'Frais PIB/PEB (IDR)',
    permitFeeIDR: 'Frais de Permis (IDR)',
    addStop: 'Ajouter un Arrêt',
    optimizeRoute: "Optimiser l'Itinéraire",
    ratePerKmIDR: 'Tarif/km (IDR)',
    adminVerified: '✓ admin',
    loadingFeeIDR: 'Frais de Chargement (IDR)',
    loadingFeeLabel: 'Frais de Chargement',
    numDays: 'Nombre de Jours',
    unitLabel: 'Unité',
    selectUnit: "Choisir l'unité",
    ratePerDayIDR: 'Tarif/jour (IDR)',
    documentType: 'Type de Document',
    feePerDocIDR: 'Frais par Document (IDR)',
    serviceFeeIDR: 'Frais de Service (IDR)',
    adminFeeIDR: "Frais d'Administration (IDR)",
    serviceName: 'Nom du Service',
    unitPriceIDR: 'Prix Unitaire (IDR)',
  ...
  oceanFreightBooking: {
    optionEconomy: 'Économique',
    optionEconomyDesc: 'Meilleur prix',
    optionStandard: 'Standard',
    optionStandardDesc: 'Équilibre prix & délai',
    optionPriority: 'Prioritaire',
    optionPriorityDesc: 'Transit le plus rapide',
    errorFillPorts: 'Veuillez renseigner le port d\'origine et de destination',
    errorSelectContainer: 'Veuillez sélectionner le type de conteneur',
    errorFillCbm: 'Veuillez renseigner le CBM ou le poids brut',
    errorNameRequired: 'Le nom est obligatoire',
    errorContactRequired: 'Le téléphone ou l\'email est obligatoire',
    successTitle: 'Demande envoyée !',
    successDesc: 'Notre équipe confirmera le devis final et vous contactera prochainement.',
    orderNumberLabel: 'Numéro de commande',
    orderAgain: 'Nouvelle commande',
    backToEstimate: 'Retour à l\'estimation',
    senderTitle: 'Coordonnées de l\'expéditeur',
    ...
    targetEtd: 'ETD cible',
    commodity: 'Marchandise',
    confirmNote: 'Notre équipe vous contactera pour confirmer le prix final dans 1×24 heures.',
    sending: 'Envoi en cours...',
    submitInquiry: 'Envoyer la demande',
    changeSearch: 'Modifier la recherche',
    resultsTitle: 'Estimation fret maritime',
    noRatesTitle: 'Tarifs non disponibles',
    noRatesDesc: 'Nous n\'avons pas encore de tarifs pour cet itinéraire. Notre équipe trouvera la meilleure offre.',
    requestManualQuote: 'Demander un devis manuel',
    daysTransit: 'jours de transit',
    estimate: 'Estimation',
    fixedPrice: 'Prix fixe',
    hideBreakdown: 'Masquer',
    showBreakdown: 'Voir',
    breakdownTitle: 'Détail des coûts',
    docCharges: 'Frais documentaires',
    totalEstimate: 'Estimation totale',
    requestManual: 'Demande manuelle',
    requestFinal: 'Demander le devis final',
    priceNote: 'Estimation initiale — prix final confirmé après réception du tarif de la compagnie maritime.',
    back: 'Retour',
    subtitle: 'Fret maritime FCL & LCL',
    shippingRoute: 'Itinéraire de transport',
    selectPort: 'Sélectionner un port...',
    cargoType: 'Type de fret',
    containerQty: 'Nombre de conteneurs',
    grossWeightKg: 'Poids brut (kg)',
    colliCount: 'Nombre de colis',
    cargoCondition: 'État de la marchandise',
    additionalServices: 'Services supplémentaires',
    additionalServicesHint: 'Sélectionnez les services requis (optionnel)',
    calculating: 'Calcul en cours...',
    checkPrice: 'Vérifier l\'estimation de prix',
    fclFull: 'FCL — Conteneur complet',
    lclLess: 'LCL — Groupage',
  
    tracking: 'Suivi',
    titleOceanFreight: 'Fret Maritime',
    labelOriginPort: 'Port d\'Origine *',
    labelDestPort: 'Port de Destination *',
    labelTradeType: 'Type de Commerce',
    labelServiceMode: 'Mode de Service',
    labelContainerType: 'Type de Conteneur *',
    ...
    tradeTypeDomestic: 'Domestique',
    tradeTypeCrossBorder: 'Transfrontalier',
    serviceModePortPort: 'Port à Port',
    serviceModeDoorPort: 'Porte à Port',
    serviceModePortDoor: 'Port à Porte',
    serviceModeDoorDoor: 'Porte à Porte',
    cargoGeneral: 'Marchandise Générale',
    cargoDG: 'Marchandise Dangereuse',
    cargoReefer: 'Réfrigéré',
    cargoFragile: 'Fragile',
    cargoOversize: 'Surdimensionné',
    cargoHighValue: 'Haute Valeur',
    addonTruckingPickup: 'Enlèvement Camion',
    addonTruckingDelivery: 'Livraison Camion',
    addonCustoms: 'Dédouanement',
    addonInsurance: 'Assurance',
    addonFumigation: 'Fumigation',
    addonCOO: 'COO / Certificat',
    addonWarehouse: 'Manutention Entrepôt',

    breakdownTHCOrigin: 'THC Origine',
    breakdownTHCDestination: 'THC Destination',
    breakdownTrucking: 'Transport Routier',
    breakdownCustomsClearance: 'Dédouanement',
},
  orderStatusLabels: {
  ...
  chooseOption: {
    loading: "Chargement des options d'offre...",
    invalidLink: "Lien invalide",
    linkExpired: "Le lien a expiré ou est introuvable.",
    choiceMade: "Choix accepté !",
    youChose: "Vous avez choisi",
    contactSoon: "Notre équipe vous contactera prochainement pour la suite.",
    orderRef: "Commande",
    offerTitle: "Offres pour vous",
    offerSubtitle: "Sélectionnez l'option la mieux adaptée à vos besoins",
    routeLabel: "Itinéraire d'expédition",
    pickupLabel: "Horaire de ramassage",
    unitType: "Type de véhicule",
    portAirport: "Port / Aéroport",
    etdEta: "ETD / ETA",
    commodity: "Marchandise",
    orderNo: "N° de commande",
    optionsCount: "options disponibles",
    includedFees: "tous frais inclus",
    ...
    processing: "En cours...",
    choose: "Choisir",
    confirmText: "Après votre sélection, notre équipe vous contactera pour la confirmation finale.",
    priceNote: "Le prix inclut les taxes et frais administratifs.",
    failedChoice: "Échec de la sélection",
    invalidToken: "Jeton invalide",
  },

  logisticTrackStatus: {
    statusOrderReceived: "Commande reçue",
    statusAdminReview: "En révision admin",
    statusRfqSent: "Recherche de fournisseur",
    statusQuoteReceived: "Devis reçu",
    statusCustomerApproval: "En attente de votre approbation",
    statusVendorConfirmed: "Fournisseur confirmé",
    statusVendorRejected: "Fournisseur refusé",
    statusInProgress: "En cours",
    statusPickup: "Enlèvement en cours",
    statusInTransit: "En transit",
    statusArrived: "Arrivé à destination",
    statusDelivered: "Livré",
    statusPodUploaded: "Preuve de livraison téléchargée",
    statusInvoiceIssued: "Facture émise",
    statusPaymentReceived: "Paiement reçu",
    statusCompleted: "Terminé",
    statusDone: "Terminé",
    statusCancelled: "Annulé",
    statusNewOrder: "Nouvelle commande",
    statusUnderReview: "En révision",
    statusQuotationSent: "Devis envoyé",
    statusCustomerApproved: "Client approuvé",
    statusProcessing: "En cours de traitement",
    stepOrderReceived: "Commande\nreçue",
    stepAdminReview: "Révision\nadmin",
    stepVendorConfirmed: "Fournisseur\nconfirmé",
    stepInProgress: "En cours",
    stepInTransit: "En\ntransit",
    stepDelivered: "Livré",
    stepPodUploaded: "Preuve\ntéléchargée",
    stepInvoiceIssued: "Facture",
    stepCompleted: "Terminé",
    stepLabelOrderReceived: "Commande reçue",
    stepLabelAdminReview: "Révision admin",
    stepLabelRfqSent: "Demande de devis",
    stepLabelQuoteReceived: "Devis reçu",
    stepLabelCustomerApproval: "Approbation",
    stepLabelVendorConfirmed: "Fournisseur confirmé",
    stepLabelInProgress: "En cours",
    stepLabelPickup: "Enlèvement",
    stepLabelInTransit: "En transit",
    stepLabelArrived: "Arrivé",
    stepLabelDelivered: "Livré",
    stepLabelPodUploaded: "POD téléchargé",
    stepLabelInvoiceIssued: "Facture",
    stepLabelPaymentReceived: "Paiement",
    stepLabelCompleted: "Terminé",
    driverAssigned: "Chauffeur assigné",
    driverAccepted: "Chauffeur accepté",
    driverOnWayPickup: "En route pour l'enlèvement",
    driverArrivedPickup: "Arrivé au point d'enlèvement",
    driverPickedUp: "Marchandise récupérée",
    driverInTransit: "En transit",
    driverArrivedDest: "Arrivé à destination",
    driverDelivered: "Livré",
    driverCompleted: "Terminé",
    payViaGateway: "Payer via la passerelle de paiement",
    preparingLink: "Préparation du lien de paiement…",
    linkFailed: "Échec de la création du lien de paiement",
    retryBtn: "Réessayer",
    orderNo: "Numéro de commande",
    totalBill: "Total à payer",
    validUntil: "Valide jusqu'au",
    securedByPaylabs: "Paiement sécurisé par Paylabs — virement bancaire, QRIS, portefeuille électronique et cartes.",
    payNow: "Payer maintenant",
    linkReused: "Le lien de paiement précédent est toujours actif et a été réutilisé.",
    linkPending: "Lien de paiement en préparation",
    linkPendingDesc: "Notre équipe vous enverra un lien de paiement via WhatsApp/email après confirmation de la commande.",
    orderCancelled: "Commande annulée",
    quoteApproved: "Vous avez approuvé ce devis",
    quoteProcessingDesc: "Notre équipe traitera votre expédition. Prix convenu :",
    quoteYourNotes: "Vos remarques :",
    quoteApprovedAt: "Approuvé le",
    quoteRejected: "Vous avez refusé ce devis",
    quoteRejectedAt: "Refusé le",
    quoteRevisionRequested: "Vous avez demandé une révision",
    quoteRevisionAt: "Demandé le",
    quoteRevisionNotes: "Notes de révision :",
    searchPlaceholder: "Entrez le numéro de commande…",
    trackBtn: "Suivre",
    verifPhoneTitle: "Vérification du téléphone",
    verifPhoneDesc: "Cette commande est protégée. Entrez les 4 derniers chiffres de votre numéro enregistré.",
    phoneLast4: "4 derniers chiffres",
    phonePlaceholder: "ex : 4321",
    verifBtn: "Vérifier",
    verifError: "Numéro incorrect. Réessayez.",
    notFound: "Commande introuvable",
    notFoundDesc: "Vérifiez le numéro de commande et réessayez.",
    backToHome: "Retour à l'accueil",
    ...
    totalAmount: "Total",
    invoiceLinks: "Facture et paiement",
    invoiceNo: "N° de facture",
    dueDate: "Date d'échéance",
    paymentStatus: "Statut du paiement",
    downloadInvoice: "Télécharger la facture",
    progress: "Progression de l'expédition",
    driverInfo: "Informations du chauffeur",
    driverStatus: "Statut du chauffeur",
    podTitle: "Preuve de livraison (POD)",
    podReceiver: "Destinataire",
    podNote: "Note",
    podSubmittedAt: "Soumis le",
    podMap: "Voir sur la carte",
    podStreetView: "Vue rue",
    updateHistory: "Historique des mises à jour",
    noUpdates: "Aucune mise à jour pour l'instant",
    pushNotifEnable: "Activer les notifications",
    pushNotifDisable: "Désactiver les notifications",
  ...
  customerOrder: {
    ...
    destination: 'Destination',
    orderDate: 'Date de commande',
    estimatedArrival: 'Estimé',
    productService: 'Produit / Service',
    truck: 'Camion',
    internal: 'Interne',
    external: 'Externe',
    total: 'Total',
    journeyHistory: 'Historique du trajet',
    noHistory: 'Aucun historique de trajet.',
    viewDocument: 'Voir le document',
    progressConfirm: 'Confirmation',
    progressPickup: 'Enlèvement',
    progressJourney: 'En transit',
    progressDelivered: 'Livré',
    progressCompleted: 'Terminé',
  },
  ppjkTrack: {
    loading: 'Chargement du suivi PPJK…',
    notFound: 'Commande introuvable',
    notFoundMsg: 'Numéro de commande invalide ou non disponible',
    backToHome: 'Retour à l\'accueil',
    statusDraft: 'Brouillon / En attente de confirmation',
    statusConfirmed: 'Confirmé',
    statusProcessing: 'En cours de traitement',
    statusSubmitted: 'Documents soumis aux douanes',
    statusExamining: 'En cours d\'examen douanier',
    statusApproved: 'Approuvé / SPPB émis',
    statusCompleted: 'Terminé',
    statusCancelled: 'Annulé',
    statusOnHold: 'En attente',
    customsPending: 'En attente',
    customsAjuFiled: 'Déclaration déposée',
    customsJalurHijau: 'Canal vert',
    customsJalurMerah: 'Canal rouge',
    customsJalurKuning: 'Canal jaune',
    customsSppbIssued: 'SPPB émis',
    customsPaid: 'Droits & taxes payés',
    customsReleased: 'Marchandises libérées',
    actionCreated: 'Commande créée',
    actionStatusChanged: 'Statut mis à jour',
    actionCustomsStatusChanged: 'Statut douanier mis à jour',
    actionDocumentUploaded: 'Document téléchargé',
    actionNoteAdded: 'Note ajoutée',
    actionUpdated: 'Données mises à jour',
    cargoInfo: 'Informations sur la cargaison',
    commodity: 'Marchandise',
    route: 'Itinéraire',
    portOfEntry: 'Port d\'entrée/sortie',
    kantorPabean: 'Bureau des douanes',
    grossWeight: 'Poids brut',
    koli: 'Colis',
    submissionDate: 'Date de soumission',
    customsDocuments: 'Numéros de documents douaniers',
    nomorAju: 'N° de déclaration',
    tanggalAju: 'Date de déclaration',
    nomorPib: 'N° PIB',
    nomorPeb: 'N° PEB',
    nomorSppb: 'N° SPPB',
    customsStatusLabel: 'Statut douanier',
    timelineTitle: 'Historique des mises à jour',
    lastUpdated: 'Dernière mise à jour',
    autoRefresh: 'La page se rafraîchit automatiquement toutes les 30 secondes',
    progressLabel: 'Progression douanière',
    cancelledMsg: 'Commande annulée — veuillez contacter notre équipe.',
    onHoldMsg: 'Commande en attente — notre équipe vous contactera prochainement.',
    completedMsg: 'Processus douanier terminé — marchandises prêtes à être récupérées ou livrées.',
    showMore: 'Voir {count} autres mises à jour',
    showLess: 'Réduire',
