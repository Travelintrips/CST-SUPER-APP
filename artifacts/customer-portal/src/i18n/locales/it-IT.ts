...
const locale: DeepRecord = {
  ...
  jasaDetail: {
    ...
    airAddQty: "Aggiungi un'altra quantità",    airCalcSummary: 'Riepilogo calcolo ({count} tipi di quantità):',
    ...
    addedToCartMsg: "{name} aggiunto all'ordine con successo!",    estimatedSubtotal: 'Subtotale stimato',
    estimatedSubtotalNote: 'Prezzo stimato · confermato dal team CST',
    addToOrderBtn: "Aggiungi all'ordine",    addedToCartConfirm: "{name} aggiunto all'ordine con successo",    recalcBtn: 'Ricalcola',
    ...
    pendingOrderHint: 'Fai prima clic su "Aggiungi all\'ordine".',    confirmOrderBtn: 'Conferma e continua ordine',
    cancelBtn: 'Annulla',
    toastAddServiceFirst: "Aggiungi prima il servizio all'ordine",    toastAddServiceDesc: 'Fai clic sul pulsante "Aggiungi all\'ordine" prima di continuare.',    toastAutoDistance: 'Distanza automatica: {km} km',
    ...
    toastNoTime: "Seleziona l'ora di ritiro",    toastNoSenderName: 'Inserisci il nome del mittente',
