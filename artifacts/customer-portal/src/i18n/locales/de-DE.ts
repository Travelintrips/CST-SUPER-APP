...
const locale: DeepRecord = {
  nav: {
    ...
    myRfqs: 'Meine Anfragen',
    myPurchaseOrders: 'Meine Bestellungen',
  ...
  orders: {
    ...
    type: 'Typ',
    total: 'Gesamt',
    emptyStateMsg: 'Ihre Bestellungen werden hier angezeigt.',
  ...
  oceanFreightBooking: {
    ...
    optionEconomyDesc: 'Günstigster Preis',
    optionStandard: 'Standard',
    optionStandardDesc: 'Balance aus Preis & Zeit',
    optionPriority: 'Priorität',
    optionPriorityDesc: 'Schnellste Lieferzeit',
    errorFillPorts: 'Bitte Abgangs- und Zielhafen ausfüllen',
    errorSelectContainer: 'Bitte Containertyp auswählen',
    errorFillCbm: 'Bitte CBM oder Bruttogewicht ausfüllen',
    errorNameRequired: 'Name ist erforderlich',
    errorContactRequired: 'Telefon oder E-Mail ist erforderlich',
    successTitle: 'Anfrage gesendet!',
    successDesc: 'Unser Team bestätigt das endgültige Angebot und kontaktiert Sie in Kürze.',
    orderNumberLabel: 'Bestellnummer',
    orderAgain: 'Neue Bestellung',
    backToEstimate: 'Zurück zur Schätzung',
    senderTitle: 'Absenderdetails',
    ...
    targetEtd: 'Ziel-ETD',
    commodity: 'Ware',
    confirmNote: 'Unser Team kontaktiert Sie zur Bestätigung des Endpreises innerhalb von 1×24 Stunden.',
    sending: 'Wird gesendet...',
    submitInquiry: 'Anfrage senden',
    changeSearch: 'Suche ändern',
    resultsTitle: 'Ocean Freight Schätzung',
    noRatesTitle: 'Keine Tarife verfügbar',
    noRatesDesc: 'Wir haben noch keine Tarife für diese Route. Unser Team findet das beste Angebot für Sie.',
    requestManualQuote: 'Manuelles Angebot anfragen',
    daysTransit: 'Tage Transit',
    estimate: 'Schätzung',
    fixedPrice: 'Festpreis',
    hideBreakdown: 'Ausblenden',
    showBreakdown: 'Anzeigen',
    breakdownTitle: 'Kostenaufschlüsselung',
    docCharges: 'Dokumentengebühren',
    totalEstimate: 'Gesamtschätzung',
    requestManual: 'Manuell anfragen',
    requestFinal: 'Endangebot anfragen',
    priceNote: 'Erste Schätzung — Endpreis wird nach Erhalt der Rate bestätigt.',
    back: 'Zurück',
    subtitle: 'Seefracht FCL & LCL',
    shippingRoute: 'Versandroute',
    selectPort: 'Hafen auswählen...',
    cargoType: 'Frachttyp',
    containerQty: 'Containeranzahl',
    grossWeightKg: 'Bruttogewicht (kg)',
    colliCount: 'Anzahl Kolli',
    cargoCondition: 'Ladungszustand',
    additionalServices: 'Zusätzliche Leistungen',
    additionalServicesHint: 'Benötigte Leistungen auswählen (optional)',
    calculating: 'Schätzung wird berechnet...',
    checkPrice: 'Preisschätzung prüfen',
    fclFull: 'FCL — Vollständiger Container',
    lclLess: 'LCL — Teilcontainer',
  
    tracking: 'Tracking',
    titleOceanFreight: 'Seefracht',
    labelOriginPort: 'Ursprungshafen *',
    labelDestPort: 'Zielhafen *',
    labelTradeType: 'Handelsrichtung',
    labelServiceMode: 'Servicetyp',
    labelContainerType: 'Containertyp *',
    labelVolumeCbm: 'Volumen (CBM)',
    transshipmentDirect: 'Direkt',
    transshipmentViaTS: 'Via T/S',
    tradeTypeExport: 'Export',
    tradeTypeImport: 'Import',
    tradeTypeDomestic: 'Inland',
    tradeTypeCrossBorder: 'Grenzüberschreitend',
    serviceModePortPort: 'Hafen zu Hafen',
    serviceModeDoorPort: 'Haus zu Hafen',
    serviceModePortDoor: 'Hafen zu Haus',
    serviceModeDoorDoor: 'Haus zu Haus',
    cargoGeneral: 'Allgemeine Fracht',
    cargoDG: 'Gefahrgut',
    cargoReefer: 'Kühlgut',
    cargoFragile: 'Zerbrechlich',
    cargoOversize: 'Übergröße',
    cargoHighValue: 'Hochwertig',
    addonTruckingPickup: 'LKW-Abholung',
    addonTruckingDelivery: 'LKW-Lieferung',
    addonCustoms: 'Zollabfertigung',
    addonInsurance: 'Versicherung',
    addonFumigation: 'Begasung',
    addonCOO: 'Ursprungszeugnis',
    addonWarehouse: 'Lagerbehandlung',

    breakdownTHCOrigin: 'THC Origin',
    breakdownTHCDestination: 'THC Destination',
    breakdownTrucking: 'LKW-Transport',
    breakdownCustomsClearance: 'Zollabfertigung',
},
  orderStatusLabels: {
  ...
  customerOrder: {
    ...
    estimatedArrival: 'Geschätzt',
    productService: 'Produkt / Dienstleistung',
    truck: 'LKW',
    internal: 'Intern',
    external: 'Extern',
    total: 'Gesamt',
    journeyHistory: 'Transportverlauf',
    noHistory: 'Noch kein Transportverlauf.',
    viewDocument: 'Dokument anzeigen',
    progressConfirm: 'Bestätigung',
    progressPickup: 'Abholung',
    progressJourney: 'Unterwegs',
    progressDelivered: 'Geliefert',
    progressCompleted: 'Abgeschlossen',
  },
  ppjkTrack: {
    loading: 'PPJK-Tracking wird geladen…',
    notFound: 'Bestellung nicht gefunden',
    notFoundMsg: 'Ungültige Bestellnummer oder noch nicht verfügbar',
    backToHome: 'Zurück zur Startseite',
    statusDraft: 'Entwurf / Warte auf Bestätigung',
    statusConfirmed: 'Bestätigt',
    statusProcessing: 'In Bearbeitung',
    statusSubmitted: 'Dokumente beim Zoll eingereicht',
    statusExamining: 'Zollprüfung läuft',
    statusApproved: 'Genehmigt / SPPB ausgestellt',
    statusCompleted: 'Abgeschlossen',
    statusCancelled: 'Storniert',
    statusOnHold: 'Zurückgestellt',
    customsPending: 'Ausstehend',
    customsAjuFiled: 'Zollanmeldung eingereicht',
    customsJalurHijau: 'Grüner Kanal',
    customsJalurMerah: 'Roter Kanal',
    customsJalurKuning: 'Gelber Kanal',
    customsSppbIssued: 'SPPB ausgestellt',
    customsPaid: 'Zölle & Steuern bezahlt',
    customsReleased: 'Ware freigegeben',
    actionCreated: 'Bestellung erstellt',
    actionStatusChanged: 'Status aktualisiert',
    actionCustomsStatusChanged: 'Zollstatus aktualisiert',
    actionDocumentUploaded: 'Dokument hochgeladen',
    actionNoteAdded: 'Notiz hinzugefügt',
    actionUpdated: 'Daten aktualisiert',
    cargoInfo: 'Frachtinformationen',
    commodity: 'Ware',
    route: 'Route',
    portOfEntry: 'Ein-/Ausgangshafen',
    kantorPabean: 'Zollamt',
    grossWeight: 'Bruttogewicht',
    koli: 'Pakete',
    submissionDate: 'Einreichungsdatum',
    customsDocuments: 'Zolldokumentnummern',
    nomorAju: 'Anmeldenummer',
    tanggalAju: 'Anmeldedatum',
    nomorPib: 'PIB-Nummer',
    nomorPeb: 'PEB-Nummer',
    nomorSppb: 'SPPB-Nummer',
    customsStatusLabel: 'Zollstatus',
    timelineTitle: 'Aktualisierungsverlauf',
    lastUpdated: 'Zuletzt aktualisiert',
    autoRefresh: 'Seite aktualisiert sich automatisch alle 30 Sekunden',
    progressLabel: 'Zollfortschritt',
    cancelledMsg: 'Bestellung storniert — bitte kontaktieren Sie unser Team.',
    onHoldMsg: 'Bestellung zurückgestellt — unser Team wird sich in Kürze melden.',
    completedMsg: 'Zollabwicklung abgeschlossen — Waren können abgeholt oder geliefert werden.',
    showMore: '{count} weitere Updates anzeigen',
